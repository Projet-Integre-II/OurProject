...
<head>
    ...
    <!-- the icon of the head hhhhhhhhhhh-->
...
<body>
    ...
    <main role="main">
<!-- Inscription Section -->
<form id="Sing" method="POST" action="Inscription.php">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name=" tele" id="inputAddress" placeholder="+2126********">
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="pays" id="inputPays">
    </div>
  </div>
  ...
  <p>avez vous déja un compte?<a href="connexion.php"> Se connecter </a></p>
